...
import 'package:gftr/View/Screens/ManageBottom/getGiftedPrivateView.dart';
...
class GetGiftedPublicPage extends StatefulWidget {
  const GetGiftedPublicPage({Key? key}) : super(key: key);

  @override
  State<GetGiftedPublicPage> createState() => _GetGiftedPublicPageState();
}

class _GetGiftedPublicPageState extends State<GetGiftedPublicPage> {
                ...
                Row(
                  ...
                  children: [
                    customText("Get Gifted", Colors.black, 20, FontWeight.w300,
                        madeOuterSans),
                    customText("Public Folders", Colors.black, 14,
                                                    ...
                                                    children: [
                                                      if (image?.length ==
                                                        ...
                                                        Expanded(
                                                          ...
                                                          //   return Image(image: AssetImage("assets/images/gift.png"),fit: BoxFit.fitHeight,);
                                                          // },
                                                          //   fit: BoxFit.fill,
                                                          //   height: screenHeight(
                                                          //       context,
        ...
        GestureDetector(
          onTap: () {
            Navigator.pushAndRemoveUntil(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        GetGiftedPrivateViewPage(indexdata: 0)),
                (route) => false);
          },
          child: Padding(
            padding:
            ...
            child: Align(
              ...
              child: Container(
                ...
                child: customText("Private Folders", Colors.white, 14,
