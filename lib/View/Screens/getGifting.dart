            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: customText("Get Gifting", Colors.black, 20,
                              ...
                              ? GridView.builder(
                                  ...
                                  gridDelegate:
                                      SliverGridDelegateWithFixedCrossAxisCount(
                                          crossAxisCount: 2,
                                          crossAxisSpacing: screenWidth(context,
                                              dividedBy: 30),
                                          mainAxisSpacing: 5.0,
                                                                              ...
                                                                              children: [
                                                                                InkWell(
                                                                                  ...
                                                                                  child: Container(
                                                                                    ...
                                                                                    child: Padding(padding: const EdgeInsets.only(left: 8.0), child: customText("No", ColorCodes.greyText, 14, FontWeight.w400, poppins)),
                                                                                  ),
                                                                                ),
                                                                                Container(
                                                                                ...
                                                                                InkWell(
                                                                                  ...
                                                                                  child: Container(margin: const EdgeInsets.only(top: 5), height: 20, width: 100, alignment: Alignment.center, child: Padding(padding: const EdgeInsets.only(left: 8.0), child: customText("Yes", ColorCodes.greyText, 14, FontWeight.w400, poppins))),
                                                                                )
                                                                              ],
                                                                            )
                                                                          ],
