...
class GftrGrannyTrish extends StatefulWidget {
  String groupName,Add;
  List<Myidea> gifts;
  List<Myidea>? PublicData;

  GftrGrannyTrish({Key? key, required this.groupName, required this.gifts, required this.Add,required this.PublicData})
      : super(key: key);
  @override
  ...
  Widget build(BuildContext context) {
    return SizedBox(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            padding: EdgeInsets.only(left: screenWidth(context, dividedBy: 30),right: screenWidth(context, dividedBy: 30)),
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                    ...
                    child: Row(
                      children: [
                        customText("Copy Address", ColorCodes.greyText, 10, FontWeight.w100, poppins),
                                  ...
                                  Stack(
                                    children: [
                                      SizedBox(
                                        ...
                                        child: ClipRRect(
                                            ...
                                            child: CachedNetworkImage(
                                              fit:  BoxFit.cover,
                                              imageUrl: widget.gifts[index].image.toString(),
                                      ...
                                      Container(
                                        ...
                                        child: widget.gifts[index].starredGift ==
                                                true
                                            ? Icon(
                                                Icons.star,
                                                color: ColorCodes.coral,
                                            ...
                                            ? GestureDetector(
                                                onTap: () {
                                                  Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                          builder: (context) => GftrDetailsViewPage(
                                                            id: widget.gifts[index].id ?? '',
                                                            url: widget.gifts[index].webViewLink ?? '',
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) =>  IdeaGrannyTrishViePage(Groupsname:  widget.groupName,PublicData: widget.PublicData ??[]),
                          ));
                    },
                    child: customButton(
