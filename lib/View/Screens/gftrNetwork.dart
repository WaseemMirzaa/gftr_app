                ...
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.only(
                        top: screenHeight(context, dividedBy: 45)),
                  ...
                  customText('Your Gftr Network', Colors.black, 18,
                    ...
                    child: BlocBuilder<MutualFrdsCubit, MutualFrdsState>(
                      builder: (context, state) {
                        ...
                        if (state is MutualFrdsLoading) {
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Spacer(),
                                          if (groupViewCubit.userReqMap.any(
                                              (element) =>
                                                  element['phoneNumber'] ==
                                                  userPhoneNumber))
                                            InkWell(
                                          ...
                                          else if (groupViewCubit.uniqueArray
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                InkWell(
                                                                  onTap:
                                                                      () async {
                                                                    await deleteFriendsCubit.Delete_frdss(
                                                                        context,
                                                                        Numbers:
                                                                            userPhoneNumber);
                                                                    await groupViewCubit
                          ...
                          final mutualFriends =
                              mutualFrdsCubit.mutulfriendd?.data ?? [];
                          final searchTerm = _searchbar.text.toLowerCase();
                          final filteredFriends = searchTerm.isEmpty
                              ? mutualFriends
                              : mutualFriends.where((friend) {
                                  final firstName =
                                      friend.frd.firstname.toLowerCase();
                                  final lastName =
                                      friend.frd.lastname.toLowerCase();
                                  return firstName.contains(searchTerm) ||
                                      lastName.contains(searchTerm);
                                }).toList();
                          return Scrollbar(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, Firstindex) {
                                ...
                                final userPhoneNumber =
                                    friend.frd.phoneNumber.toString();
                                ...
                                return Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      width:
                                          screenWidth(context, dividedBy: 1.08),
                                      alignment: Alignment.center,
                                      margin: EdgeInsets.only(
                                          top: screenHeight(context,
                                              dividedBy: 100)),
                                                                      ...
                                                                      Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              itemCount: friend.mutualby.length,
                                                                              itemBuilder: (context, index) {
                                                                                return Row(
                                                                                  children: [
                                                                                    CircleAvatar(
                  ...
                  customText("Invite New Gftrs", Colors.black, 18,
                      FontWeight.w600, poppins),
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: customText('Invite By Text', ColorCodes.coral,
                              10, FontWeight.w500, poppins),
                        ),
                      ),
                      SizedBox(width: screenWidth(context, dividedBy: 20)),
                      customText(
                          "Or", Colors.black, 11, FontWeight.w400, poppins),
                      SizedBox(width: screenWidth(context, dividedBy: 20)),
                      GestureDetector(
                        onTap: () async {
                          // sendEmail();
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              border: GradientBoxBorder(
                                  gradient: coralTealColor, width: 1),
                              borderRadius: BorderRadius.circular(25)),
                          child: customText('Invite By E-Mail',
                              ColorCodes.coral, 10, FontWeight.w500, poppins),
                        ),
                      ),
                    ],
                  ),
