              ...
              child: Column(
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.only(top: screenHeight(context, dividedBy: 45)),
                  ...
                  customText('Your Gftr Network', Colors.black, 18, FontWeight.w600, poppins),
                  SizedBox(
                    height: screenHeight(context,dividedBy: 2.45),
                    // color: Colors.red,
                    child:
                    BlocBuilder<MutualFrdsCubit, MutualFrdsState>(
                        ...
                        if (state is MutualFrdsLoading) {
                          ...
                          return Scrollbar(
                            ...
                            child: ListView.builder(
                              controller: _secondController,
                              itemCount:_searchbar.text.isNotEmpty? results.length :_users.length,
                                          ...
                                          Container(
                                            decoration: BoxDecoration(
                                                border: GradientBoxBorder(
                                                    gradient: coralTealColor, width: 2),
                                                shape: BoxShape.circle),
                                            child: CircleAvatar(
                                              backgroundImage:_searchbar.text.isNotEmpty?
                                              NetworkImage("${ApiConstants.baseUrlsSocket}${results[index]['avatar']}"):
                                              NetworkImage("${ApiConstants.baseUrlsSocket}${_users[index]['avatar']}"),
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Text("${_searchbar.text.isNotEmpty?results[index]['firstname']:_users[index]['firstname']}",
                                                  style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize:  15,
                                              ...
                                              customText("${_searchbar.text.isNotEmpty?results[index]['phoneNumber']:_users[index]['phoneNumber']}" , ColorCodes.greyText, 10,
                                                  FontWeight.w100, poppins),
                                            ],
                                          ),
                                          Spacer(),
                                          if (isBotton && e.contains("${_searchbar.text.isNotEmpty?results[index]['phoneNumber']:_users[index]['phoneNumber']}") )
                                            Container(
                                            ...
                                            if(f.contains("${_searchbar.text.isNotEmpty?results[index]['phoneNumber']:_users[index]['phoneNumber']}")) Container(
                                                margin: EdgeInsets.only(
                                                    left: screenWidth(context, dividedBy: 6),
                                                ...
                                                child: InkWell(
                                                              ...
                                                              children: [
                                                                ...
                                                                InkWell(
                                                                  onTap: () async {
                                                                    ...
                                                                    print("hyyy:${_users[index]['phoneNumber']}");
                                                                    setState(() {
                                                                      deleteFriendsCubit.Delete_frdss(context, Numbers: "${_searchbar.text.isNotEmpty?results[index]['phoneNumber']:_users[index]['phoneNumber']}");
                                                                    });
                                                                    ...
                                                                    Timer(Duration(milliseconds: 1500), () {
                                                                      setState(() {
                                                                        groupViewCubit.uniqueArray;
                                                                        f.remove("${_searchbar.text.isNotEmpty?results[index]['phoneNumber']:_users[index]['phoneNumber']}");
                                                                        // groupViewCubit.usernum.remove(usersviewsCubit.viewAllUsers!.data?[index].phoneNumber.toString());
                                                                        chang = true;
                                                                        print("========== ${groupViewCubit.uniqueArray.toString()}");
                                                                        print("==========fff ${f}");
                                                                      });
                                                                    });
                                                                  },
                                                  ...
                                                  child: customText('Remove', Colors.black, 10,
                                                      FontWeight.w100, poppins),
                                                )
                                            )
                                            else Container(
                                              ...
                                              child: GestureDetector(
                                                onTap: () {
                                                  setState(() {
                                                    if(c.contains("${_searchbar.text.isNotEmpty?results[index]['phoneNumber']:_users[index]['phoneNumber']}")){
                                                      c.remove("${_searchbar.text.isNotEmpty?results[index]['phoneNumber']:_users[index]['phoneNumber']}");
                                                    }else{
                                                      c.add("${_searchbar.text.isNotEmpty?results[index]['phoneNumber']:_users[index]['phoneNumber']}");
                                                      buildGroupCubit.getBuilGrop(context, checkData: c);
                                                    }
                                                    print(_searchbar.text.isNotEmpty?results[index]['phoneNumber']:_users[index]['phoneNumber']);
                                                    e.addAll(c);
                                                    isBotton=true;
                                                    c.clear();
                                                    print("c:$c");
                                                ...
                                                child: customText('Add', Colors.white, 10,
                                                    FontWeight.w100, poppins),
                                              ),
                                            ),
                                          SizedBox(width: screenWidth(context, dividedBy: 30)),
                          ...
                          return Scrollbar(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, Firstindex) {
                                final mutuInt =mutualFrdsCubit.mutulfriendd!.data![Firstindex].mutualby.length;
                                return Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: CircleAvatar(
                                              backgroundImage:
                                              NetworkImage("${ApiConstants.baseUrlsSocket}${mutualFrdsCubit.mutulfriendd?.data?[Firstindex].frd.avatar}"),
                                              // AssetImage(ImageConstants.dummyProfile),
                                              radius: 23,
                                            ),
                                          ),
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                width: screenWidth(context,dividedBy: 4),
                                                child:
                                                Text("${mutualFrdsCubit.mutulfriendd?.data?[Firstindex].frd.firstname}",
                                                  style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize:  15,
                                                    fontWeight: FontWeight.w200,
                                              ...
                                              Container(
                                                alignment: Alignment.center,
                                                height: screenHeight(context,dividedBy: 25),
                                                width: screenWidth(context,dividedBy: 2.15),
                                                child: Row(
                                                  children: [
                                                    Text("Mutual : ${mutualFrdsCubit.mutulfriendd?.data?[Firstindex].mutualby[0].name}",
                                                      style: TextStyle(
                                                        color: Colors.black,
                                                        fontSize:  12,
                                                        fontWeight: FontWeight.w200,
                                                    ...
                                                    InkWell(
                                                            ...
                                                            content: Container(
                                                                ...
                                                                child: Scrollbar(
                                                                  ...
                                                                  child: ListView.separated(
                                                                    ...
                                                                    itemCount: mutualFrdsCubit.mutulfriendd!.data![Firstindex].mutualby.length,
                                                                    itemBuilder: (context, index) {
                                                                      return Row(
                                                                        children: [
                                                                          CircleAvatar(
                                                      ...
                                                      child: Text(" +${mutuInt.toString().length}",
                                                        style: TextStyle(
                                                          color: Colors.black,
                                                          fontSize:  12,
                                                          fontWeight: FontWeight.w200,
                                          ...
                                          if (isBotton && e.contains(mutualFrdsCubit.mutulfriendd?.data?[Firstindex].frd.phoneNumber.toString()))
                                            Container(
                                              margin: EdgeInsets.only(
                                            ...
                                            if(f.contains(mutualFrdsCubit.mutulfriendd?.data?[Firstindex].frd.phoneNumber.toString())) Container(
                                                margin: EdgeInsets.only(
                                                    left: screenWidth(context, dividedBy: 16.05),
                                                          ...
                                                          children: [
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                InkWell(
                                                                  onTap: () async {
                                                                    deleteFriendsCubit.Delete_frdss(context, Numbers: "${mutualFrdsCubit.mutulfriendd?.data?[Firstindex].frd.phoneNumber.toString()}").then((value) {
                                                                      mutualFrdsCubit.mutual_frds();
                                                                      groupViewCubit.getGroups();
                                                                      groupViewCubit.uniqueArray;
                                                                      f.remove("${mutualFrdsCubit.mutulfriendd?.data?[Firstindex].frd.phoneNumber.toString()}");
                                                                      Navigator.pop(context);
                                                                    },);
                                              ...
                                              child: GestureDetector(
                                                onTap: () {
                                                  setState(() {
                                                    if(c.contains(mutualFrdsCubit.mutulfriendd?.data?[Firstindex].frd.phoneNumber.toString())){
                                                      c.remove(mutualFrdsCubit.mutulfriendd?.data?[Firstindex].frd.phoneNumber.toString());
                                                    }else{
                                                      c.add(mutualFrdsCubit.mutulfriendd?.data?[Firstindex].frd.phoneNumber.toString());
                                                      buildGroupCubit.getBuilGrop(context, checkData: c);
                                                    }
                                                    f=groupViewCubit.uniqueArray;
                                                    e.addAll(c);
